...
# Usamos resultados ya generados
...
ax.barh(y, [-percent for percent in other_percentage], bar_width, label="Other Industries", color="skyblue")

ax.barh(y, rnd_percentage, bar_width, label="R&D", color="salmon")


ax.set_yticks(y)
ax.set_yticklabels(years)
ax.set_xlabel("Percentage of Diverse Companies (%)", fontsize=12)
ax.set_ylabel("Fiscal Year", fontsize=12)
ax.set_title("Percentage of Diverse Companies (R&D vs. Other Industries)", fontsize=14)
ax.legend()
